...
Admin.Init = function () {
    ...
    $('input[type=radio]').on('focus', function () { $(this).blur(); });
    $('input[type=checkbox]').on('focus', function () { $(this).blur(); });
    ...
    // 三态按钮
    $('.btn')
        .on('mousedown', function () { $(this).addClass('btn-active'); })
        .on('mouseup', function () { $(this).removeClass('btn-active'); })
        .on('mouseover', function () { $(this).addClass('btn-hover'); })
        .on('mouseout', function () { $(this).removeClass('btn-active'); $(this).removeClass('btn-hover'); });
    $('.btn-lit')
        .on('mousedown', function () { $(this).addClass('btn-lit-active'); })
        .on('mouseup', function () { $(this).removeClass('btn-lit-active'); })
        .on('mouseover', function () { $(this).addClass('btn-lit-hover'); })
        .on('mouseout', function () { $(this).removeClass('btn-lit-active'); $(this).removeClass('btn-lit-hover'); });
