        ...
        <div id="accordion" class="easyui-accordion" style="width: 260px; height: auto;">
                ...
                <div title="功能管理" data-options="collapsed:false,collapsible:false" style="padding: 10px;">
                    <ul class="tempul">
                        ...
                        <li><a href="javascript:void(0)" onclick="addTab('书籍管理','SystemModule/Sys/Modules/modulelist.aspx')"> <span>书籍管理</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('导入导出管理[一级目录]','ImportBook1Level.aspx')"> <span>导入导出管理[一级目录]</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('导入导出管理[二级目录]','ImportBook2Level.aspx')"> <span>导入导出管理[二级目录]</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('导入导出管理[三级目录]','ImportBook3Level.aspx')"> <span>导入导出管理[三级目录]</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('导入导出管理[四级目录]','ImportBook4Level.aspx')"> <span>导入导出管理[四级目录]</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('导入导出管理[五级目录]','ImportBook5Level.aspx')"> <span>导入导出管理[五级目录]</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('注册用户管理','UserManage.aspx')"> <span>注册用户管理</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('注册用户日志管理','UserRegistLogManage.aspx')"> <span>注册用户日志管理</span></a></li>
                        <li><a href="javascript:void(0)" onclick="addTab('书籍注册码管理','RegistCodeManage.aspx')"> <span>书籍注册码管理</span></a></li>
