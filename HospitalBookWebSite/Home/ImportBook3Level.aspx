<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportBook3Level.aspx.cs" Inherits="HospitalBookWebSite.Home.ImportBook3Level" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
      <table width="100%">
            <tr>
                <td>第一级：<asp:TextBox ID="txtLevelOne" runat="server" Width="50px" CssClass="BigInput" >部分</asp:TextBox>
                    第二级：<asp:TextBox ID="txtLevelTwo" runat="server" Width="50px" CssClass="BigInput" >篇</asp:TextBox>
                    第三级：<asp:TextBox ID="txtLevelThree" runat="server" Width="43px" CssClass="BigInput" >单元</asp:TextBox>
                    <br />
                    <br />
